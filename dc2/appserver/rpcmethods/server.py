...
@rpcmethod(
    name="dc2.inventory.servers.list",
...
@rpcmethod(
    name="dc2.inventory.servers.add",
...
@rpcmethod(
    name="dc2.inventory.servers.update",
...
@rpcmethod(
    name="dc2.inventory.servers.find",
    returns={"list servers": "List of found server records"},
    params={
        "dict rec_server": "Pre-Filled record dictionary with search terms"},
    is_xmlrpc=True, is_jsonrpc=True)
...
@rpcmethod(
    name="dc2.inventory.servers.delete",
...
@rpcmethod(
    name="dc2.inventory.servers.delete_complete",
...
@rpcmethod(
    name="dc2.inventory.servers.list_without_hosts",
