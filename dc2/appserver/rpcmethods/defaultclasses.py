...
@rpcmethod(
    name="dc2.configuration.defaultclasses.list",
    returns={"list defaultclasses": "List of type defaultclasses record"},
    params={"dict defclasses_rec": "Defclasses record"},
...
@rpcmethod(
    name="dc2.configuration.defaultclasses.add",
...
@rpcmethod(
    name="dc2.configuration.defaultclasses.update",
    returns={"string doc_id": "Document ID"},
    params={"dict defclasses_rec": "Defclasses record"},
    is_xmlrpc=True, is_jsonrpc=True)
