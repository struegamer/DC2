...
class JSONHostBackendController(JSONController):
    ...
    def _prepare_urls(self):
        self.add_url_handler_to_verb('GET',
                                     'backend_host_list', 'backend_host_list')
        self.add_process_method('backend_host_list', self._backend_host_list)

        self.add_url_handler_to_verb('GET', 'backend_host_get_server_info',
                                     'backend_host_get_server_info')
        self.add_process_method('backend_host_get_server_info',
                                self._backend_host_get_server_info)
