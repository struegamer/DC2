...
************************************************************************ */
qx.Class.define("cs2.frontend.dialogs.SSLCsrView",
{
  ...
  members: {
    ...
    _createLayout:function() {
      ...
      this._edit_csr_commonname=new qx.ui.basic.Label();
      this._edit_csr_keyname=new qx.ui.basic.Label();
      this._edit_csr_pem_contents=new qx.ui.form.TextArea().set({width:400,height:300});
      this._edit_csr_pem_contents.setReadOnly(true);
      ...
      comp.add(this._edit_csr_pem_contents,{row:3,column:0,colSpan:2});
    ...
    setData:function(data) {
      if (data != null) {
        this._edit_csr_commonname.setValue(data["commonname"]);
        this._edit_csr_keyname.setValue(data["csr_with_key"]);
        this._edit_csr_pem_contents.setValue(data["csr_pem"]);
      }
    }
  }
});