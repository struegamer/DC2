...
************************************************************************ */
qx.Class.define("cs2.frontend.dialogs.SSLCertView",
{
  ...
  members: {
    _edit_cert_commonname:null,
    _edit_cert_pem_contents:null,
    _createLayout:function() {
      ...
      this._edit_cert_commonname=new qx.ui.basic.Label();
    ...
    setData:function(data) {
      if (data != null) {
        this._edit_cert_commonname.setValue(data["commonname"]);
        this._edit_cert_pem_contents.setValue(data["cert_pem"]);
      }
    }
  }
});